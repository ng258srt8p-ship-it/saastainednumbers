...
To calculate MRR: multiply your number of paying customers by your average revenue per user. You can [use our MRR calculator](/revenue/mrr-calculator) to compute it instantly.
...
Calculate CAC by dividing total sales and marketing costs by the number of new customers acquired. Our [CAC calculator](/growth-efficiency/cac-calculator) makes this simple.
...
Use our [LTV calculator](/revenue/ltv-calculator) to compute customer lifetime value based on your ARPU, gross margin, and churn rate.
...
Track both monthly and annual churn. Our [churn calculator](/churn-retention/churn-calculator) handles both calculations automatically.
...
Calculate NRR by dividing ending MRR (excluding new customers) by starting MRR. Our [NRR calculator](/revenue/nrr-calculator) computes this including expansions, churn, and contractions.
...
Our [Rule of 40 calculator](/growth-efficiency/rule-of-40-calculator) shows where your company stands.
...
Our [burn rate calculator](/growth-efficiency/burn-rate-calculator) computes gross burn, net burn, and cash runway in seconds.
...
Calculate yours with our [magic number calculator](/growth-efficiency/magic-number-calculator).
...
Use our [payback period calculator](/unit-economics/payback-period-calculator) to see your payback timeline.
