...
const config = {
  ...
  content: {
    ...
    benchmarks: "Capital-efficient SaaS companies achieve a ratio above 1.0, meaning each dollar raised generates more than a dollar of ARR when adjusted for growth. Top-quartile efficient companies like Mailchimp and Atlassian historically operated above 2.0. The median SaaS company operates at 0.3-0.7. Companies with ratios below 0.25 typically struggle to raise follow-on funding without demonstrating a clear path to improved efficiency.",
    benchmarkData: [
      { metric: "Excellent Capital Efficiency", value: "> 1.0", source: "KeyBanc Capital Markets" },
      { metric: "Good Capital Efficiency", value: "0.5 - 1.0", source: "KeyBanc Capital Markets" },
