...
const config = {
  ...
  content: {
    intro: "Newsletters have become a lucrative revenue channel for independent creators, journalists, and experts. Platforms like Substack and ConvertKit make it easy to monetize through both paid subscriptions and sponsorships. The key metrics are subscriber growth, conversion rate (typically 2-10%), and engagement (open rates of 30-60%). Top newsletters earn millions annually, but even a modest 10K subscriber list can generate a solid side income.",
    ...
    faq: [
      ...
      { question: "What are the best newsletter platforms for monetization?", answer: "Substack (all-in-one, built-in paid subscriptions, no transaction fees on first $1K), ConvertKit (advanced automation, audience segmentation), Beehiiv (built-in ad network, growth tools), and Revue (Twitter integration). Substack is best for simplicity, Beehiiv for growth features, ConvertKit for deep audience management." },
