...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "What is the best way to monetize a podcast?", answer: "Tiered approach: 1) Programmatic ads (AdvertiseCast, Megaphone) at any scale. 2) Direct sponsorships at 5K+ downloads  -  host-read ads pay 2-3x more. 3) Listener support ([Patreon](https://patreon.com), Buy Me a Coffee). 4) Premium content or courses. 5) Live events and merchandise. Most revenue comes from the top few sources." },
