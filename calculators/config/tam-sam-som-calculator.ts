...
const config = {
  ...
  content: {
    ...
    benchmarkData: [
      { metric: "Early-Stage SOM/TAM Ratio", value: "1-5%", source: "General benchmark" },
      { metric: "Healthy SAM/TAM Ratio", value: "20%+", source: "General benchmark" },
      { metric: "High-Growth Market CAGR", value: "15%+", source: "General benchmark" },
      { metric: "Venture-Backable TAM Minimum", value: "$1B+", source: "General benchmark" },
      { metric: "Typical SOM as % of SAM", value: "10-30%", source: "General benchmark" },
    ],
