...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "Should I include voluntary and involuntary churn?", answer: "Yes. Track both types separately but include both in your total churn calculation for accuracy. Voluntary churn (customers who cancel) and involuntary churn (failed payments) require different solutions." },
      ...
      { question: "How do I reduce monthly churn rate?", answer: "Focus on onboarding improvement (reduce time-to-value), proactive customer success (reach out before renewal), pricing optimization (right-size plans), and product improvements based on churn feedback." },
