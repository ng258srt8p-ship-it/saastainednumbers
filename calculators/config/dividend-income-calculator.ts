...
const config = {
  ...
  content: {
    ...
    howToUse: "Enter your initial investment amount, monthly contributions you plan to make, the current dividend yield of your target portfolio, the expected annual dividend growth rate, and investment time horizon. The calculator shows your total invested amount, projected portfolio value, and estimated annual and monthly dividend income. For a conservative estimate, use 3-4% yield with 5-6% dividend growth (matching S&P 500 dividend growth rates). For a high-income approach, use 5-7% yield with 2-4% growth (REITs, BDCs, or preferred stocks). Use [NerdWallet](https://nerdwallet.com) to screen for high-dividend stocks and ETFs like VYM, SCHD, or VIG for diversified dividend exposure.",
