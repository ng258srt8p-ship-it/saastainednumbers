...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "Where should I keep my emergency fund?", answer: "High-yield savings account (HYSA) earning 3.5-5.0% APR. NOT in stocks (too volatile for short-term needs). NOT in a checking account (too easy to spend). A HYSA at Ally, Marcus, or SoFi offers the right balance of accessibility, safety (FDIC insured), and yield. Compare savings rates on [NerdWallet](https://nerdwallet.com)." },
