...
const config = {
  ...
  content: {
    ...
    benchmarks: "According to KeyBanc Capital Markets 2025 SaaS Survey, top-quartile SaaS companies grow MRR 20-25% month-over-month in early stages. Median growth for Seed-stage companies is 15-20% MoM. At Series A, median growth drops to 10-15% MoM. At growth stage ($5M+ ARR), 5-10% MoM is strong. Companies growing below 5% MoM at scale risk stagnation.",
    benchmarkData: [
      { metric: "Top Quartile Early Stage", value: "20 - 25% / month", source: "KeyBanc 2025 SaaS Survey" },
      { metric: "Median Seed Stage", value: "15 - 20% / month", source: "KeyBanc Capital Markets" },
      { metric: "Median Series A", value: "10 - 15% / month", source: "KeyBanc Capital Markets" },
      { metric: "Growth Stage ($5M+ ARR)", value: "5 - 10% / month", source: "SaaS Capital" },
      { metric: "Signs of Stagnation", value: "< 5% / month", source: "General benchmark" },
    ],
    ...
    faq: [
      ...
      { question: "How does pricing affect MRR growth rate?", answer: "Higher prices increase MRR per customer, improving growth rate. But higher prices may reduce new customer acquisition. Find the optimal price point that maximizes net MRR growth. Track MRR growth automatically with [Baremetrics](https://baremetrics.com?via=saastainednumbers)." },
