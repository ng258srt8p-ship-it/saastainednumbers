...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How can I increase my POD profit margin?", answer: "Raise your selling price (even $2-3 improves margin significantly without losing sales), choose lower-cost print providers, optimize product selection (mugs and phone cases have higher margins than t-shirts), bundle products for higher average order value, reduce shipping costs with flat-rate options, and create designs for niche audiences that are less price-sensitive. Build your own independent store rather than relying solely on Etsy or Amazon." },
