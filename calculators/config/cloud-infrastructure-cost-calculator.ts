...
const config = {
  ...
  content: {
    ...
    benchmarkData: [
      ...
      { metric: "Data Transfer as % of Cloud Spend", value: "10-20%", source: "General benchmark" },
      { metric: "Managed Services as % of Cloud Spend", value: "10-30%", source: "General benchmark" },
      { metric: "Early-Stage Startup Cloud Cost", value: "$500-5K/month", source: "General benchmark" },
    ],
