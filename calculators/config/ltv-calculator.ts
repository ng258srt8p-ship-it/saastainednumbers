...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "Can LTV change over time?", answer: "Yes. LTV changes as your ARPU, margins, and churn rate evolve. Track it monthly to spot trends. Improving retention or increasing pricing both increase LTV. Track LTV trends automatically with [Baremetrics](https://baremetrics.com?via=saastainednumbers)." },
