...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "Can LTV change over time?", answer: "Yes. LTV changes as your ARPU, margins, and churn rate evolve. Track it monthly to spot trends. Improving retention or increasing pricing both increase LTV." },
      { question: "How does churn rate affect LTV?", answer: "Dramatically. Reducing monthly churn from 5% to 3% increases average customer lifetime from 20 to 33 months, boosting LTV by 65%. Small retention improvements produce outsized LTV gains." },
