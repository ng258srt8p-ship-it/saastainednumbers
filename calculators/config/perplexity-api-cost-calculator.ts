...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "What is the difference between Sonar and Sonar Pro?", answer: "Sonar is the standard model for search-augmented generation with basic citations ($1.00/M input, $5.00/M output). Sonar Pro ($3.00/M input, $15.00/M output) provides deeper research with more sources, longer-form answers, and better reasoning. Use Sonar for simple Q&A and Sonar Pro for in-depth research and analysis." },
