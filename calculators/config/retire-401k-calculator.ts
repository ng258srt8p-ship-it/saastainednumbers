...
const config = {
  ...
  inputs: [
    ...
    { id: "annualContribution", label: "Annual Contribution ($)", type: "currency" as const, defaultValue: 19500, min: 0 },
    { id: "employerMatchPercent", label: "Employer Match (%)", type: "percentage" as const, defaultValue: 100, min: 0, max: 100 },
    { id: "employerMatchCap", label: "Employer Match Cap ($)", type: "currency" as const, defaultValue: 9750, min: 0 },
  ...
  content: {
    ...
    benchmarks: "The average 401k balance is approximately $112K overall, $42K for ages 30-39, $142K for ages 40-49, and $250K for ages 50-59 (Fidelity 2025 data). A 30-year-old with $50K saved, contributing $19,500/year with a 100% match on the first $9,750, earning 7% annual returns, would have approximately $2.8M by age 65  -  providing $112K/year in retirement income. The IRS allows catch-up contributions of $7,500/year for those 50+. Only 32% of workers contribute enough to receive the full employer match. Fidelity recommends saving 15% of your income (including employer match) for retirement. For more benchmarks, visit [NerdWallet](https://nerdwallet.com) or [Fool.com](https://fool.com).",
    benchmarkData: [
      { metric: "Average 401k Balance (All Ages)", value: "$112,000", source: "Fidelity 2025" },
      { metric: "Average 401k Balance (Age 30-39)", value: "$42,000", source: "Fidelity 2025" },
      { metric: "2025 Employee Contribution Limit", value: "$23,000", source: "IRS" },
