...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How do I increase my Etsy profit margin?", answer: "Raise prices (even $1-2 helps), buy materials in bulk for discounts, reduce shipping costs with flat-rate boxes or regional carriers, batch production for efficiency, increase item price to cover shipping with free shipping, and optimize product photography to reduce return rates. Scale to your own website with [Shopify](https://shopify.pxf.io/2R5Dza) to reduce marketplace fees and capture higher margins." },
