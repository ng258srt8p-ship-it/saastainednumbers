...
const config = {
  ...
  content: {
    intro: "YouTube ad revenue is the primary income source for most creators on the platform, but earnings vary dramatically by niche, audience location, and video length. RPM (Revenue Per Mille)  -  the amount you earn per 1,000 views  -  ranges from $0.50 for entertainment content to $15+ for finance and business channels. This calculator helps you estimate your YouTube earnings based on your current or projected view counts. Beyond ad revenue, successful creators diversify with sponsorships, affiliate marketing, and [Shopify](https://shopify.pxf.io/2R5Dza) merchandise stores to multiply their income.",
