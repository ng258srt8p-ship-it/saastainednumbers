...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How does pricing affect break-even point?", answer: "A 10% price increase can reduce your break-even units by 20-30% while maintaining revenue. Small price changes have a leveraged effect on break-even because they drop straight to contribution margin. Test pricing regularly  -  most founders underprice their products." },
