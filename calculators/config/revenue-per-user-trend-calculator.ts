...
const config = {
  ...
  content: {
    intro: "Revenue Per User (ARPU) Trend Analysis tracks how your average revenue per user changes month over month, revealing whether your monetization strategy is improving, stagnating, or declining. Growing ARPU means you are successfully upselling, expanding usage, or raising prices. Declining ARPU suggests you may be adding lower-value customers, experiencing plan downgrades, or facing pricing pressure from competitors. ARPU trend is a key leading indicator of revenue health because it separates growth driven by customer acquisition from growth driven by increasing customer value. A company adding 1,000 customers at $10/month ARPU is growing differently than one adding 500 customers at $50/month ARPU. This calculator computes your current and previous ARPU, calculates the percentage growth, and classifies the trend as Growing, Stable, or Declining. Use it to monitor your monetization trajectory and make informed pricing and packaging decisions.",
