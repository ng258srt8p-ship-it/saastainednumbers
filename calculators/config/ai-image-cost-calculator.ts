...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "What is Flux and how does it compare to other generators?", answer: "Flux by Black Forest Labs (created by former Stability AI researchers) offers top-tier image quality at $0.05/image via API. It rivals Midjourney in quality but is available via API for easier integration. Flux is open-weight, enabling self-hosting for lower costs." },
