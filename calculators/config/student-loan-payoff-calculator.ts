...
const config = {
  ...
  content: {
    ...
    howToUse: "Enter your total student loan balance, the weighted average interest rate across all your loans, and the monthly payment you can afford. The calculator shows your payoff timeline, total interest paid, and total amount paid. Experiment with higher payment amounts to see how much you can save in interest. To calculate your weighted average interest rate, multiply each loan's rate by its balance, sum them, and divide by the total balance. Check [NerdWallet](https://nerdwallet.com) or [Bankrate](https://bankrate.com) for current refinance rates if you have private loans. Federal loan borrowers should consider income-driven repayment plans through [StudentAid.gov](https://studentaid.gov) before refinancing, as refinancing federal loans with a private lender forfeits federal protections.",
