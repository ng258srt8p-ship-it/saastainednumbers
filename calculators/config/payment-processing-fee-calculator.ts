...
const config = {
  ...
  content: {
    ...
    benchmarkData: [
      { metric: "Low-Risk Business Effective Rate", value: "2-2.5%", source: "General benchmark" },
      { metric: "Standard E-commerce Effective Rate", value: "2.5-3.5%", source: "General benchmark" },
      { metric: "High-Risk Effective Rate", value: "4-7%", source: "General benchmark" },
      { metric: "Visa/MC Chargeback Threshold", value: "< 1%", source: "Card Network Rules" },
      { metric: "Average Chargeback Fee", value: "$15-25", source: "General benchmark" },
