...
const config = {
  ...
  meta: {
    title: "Lead-to-Customer Conversion Rate Calculator",
    description: "Calculate what percentage of your leads convert into paying customers and measure your sales funnel efficiency.",
    keywords: ["lead conversion", "conversion rate", "sales funnel", "lead to customer", "cac efficiency"],
  },
  inputs: [
    { id: "leads", label: "Total Leads", type: "number" as const, defaultValue: 2000 },
    { id: "customers", label: "New Customers", type: "number" as const, defaultValue: 100 },
  ],
  outputs: [
    { id: "conversionRate", label: "Lead-to-Customer Conversion Rate", type: "percentage" as const, isPrimary: true },
  ...
  content: {
    ...
    faq: [
      { question: "What is a good lead-to-customer conversion rate?", answer: "5% is good, 10%+ is excellent. Median B2B SaaS ranges from 2-5%. The right benchmark depends on your sales model and lead quality." },
      { question: "How do I improve lead conversion rate?", answer: "Improve lead qualification (better targeting), optimize sales follow-up process, provide better demo experiences, address objections proactively, and nurture leads that aren't ready to buy." },
      { question: "Should I track MQL-to-Customer or SQL-to-Customer?", answer: "Both. MQL-to-Customer measures full funnel efficiency (marketing + sales). SQL-to-Customer isolates sales effectiveness. Track both to identify where the funnel leaks." },
      { question: "How does lead conversion rate affect CAC?", answer: "Directly. If conversion rate doubles, CAC halves (assuming same lead cost). Improving conversion is often the most cost-effective way to reduce CAC." },
      { question: "How often should I track conversion rate?", answer: "Monthly. Track by lead source, campaign, and sales rep weekly for optimization. Changes in conversion rate are early warning signals for sales or product issues." },
      { question: "What causes low lead conversion?", answer: "Poor lead quality (wrong audience), weak value proposition, pricing objections, long sales cycles, competitor wins, insufficient follow-up, or product-market fit gaps." },
      { question: "How does product-led growth affect lead conversion?", answer: "PLG companies often see higher conversion rates because users experience product value before being asked to buy. Self-serve funnels can achieve 5-15% conversion from active users." },
