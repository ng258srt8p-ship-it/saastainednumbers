...
const config = {
  ...
  content: {
    ...
    benchmarks: "AOV varies significantly by industry. Apparel averages $50-100, electronics $100-300, home goods $75-150, subscription boxes $25-50, B2B $500-2000+ Luxury goods can exceed $500. Use [Google Analytics](https://analytics.google.com) e-commerce tracking to monitor your AOV trends.",
    benchmarkData: [
