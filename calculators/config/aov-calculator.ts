...
const config = {
  ...
  content: {
    ...
    benchmarkData: [
      { metric: "Apparel AOV", value: "$50-100", source: "Industry Average" },
      { metric: "Electronics AOV", value: "$100-300", source: "Industry Average" },
      { metric: "Home Goods AOV", value: "$75-150", source: "Industry Average" },
      { metric: "Subscription Box AOV", value: "$25-50", source: "Recharge" },
      { metric: "B2B AOV", value: "$500-2000+", source: "Industry Average" },
