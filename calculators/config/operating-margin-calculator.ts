...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How is operating margin different from gross margin?", answer: "Gross margin only subtracts COGS. Operating margin subtracts ALL operating expenses including R&D, sales & marketing, and G&A. Operating margin is a broader measure of business profitability." },
