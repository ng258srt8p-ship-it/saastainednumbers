...
const config = {
  ...
  content: {
    intro: "Revenue Per Employee is a critical efficiency metric that measures how much revenue your company generates per team member. It reveals how effectively you are using your workforce and is widely used to benchmark against industry peers. High revenue per employee suggests efficient operations, strong product-market fit, and scalable systems. Low revenue per employee may indicate over-hiring, process inefficiencies, or a services-heavy business model. This simple but key metric is one of the first things investors look at when evaluating operational efficiency.",
