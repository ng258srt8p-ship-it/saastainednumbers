...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How do I calculate ROI for marketing campaigns?", answer: "Marketing ROI = (Revenue Attributed to Campaign  -  Campaign Cost) / Campaign Cost × 100. Use UTM parameters and conversion tracking to attribute revenue accurately. Account for all costs: ad spend, creative production, tools, and team time. A 5:1 ratio ($5 revenue per $1 spend) is excellent. Track campaign performance and attribute revenue with [HubSpot](https://hubspot.com) for end-to-end marketing ROI analysis." },
