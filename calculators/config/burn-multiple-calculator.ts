...
const config = {
  ...
  faq: [{"question": "Why is burn multiple important for investors?", "answer": "It is a direct measure of how effectively a company is converting cash into ARR. It is a more comprehensive efficiency metric than CAC alone, as it accounts for overall spending."}, {"question": "How does burn multiple change as a company scales?", "answer": "Typically, as companies scale and reach more efficient stages, their burn multiple should ideally decrease, indicating improved capital efficiency."}, {"question": "What is the relationship between burn multiple and CAC?", "answer": "While CAC focuses on the cost of one customer, burn multiple focuses on the efficiency of the entire company's growth spending. A low CAC is useless if the rest of the company's burn is inefficient."}]
},
  locales: {
    es: {
      meta: {
