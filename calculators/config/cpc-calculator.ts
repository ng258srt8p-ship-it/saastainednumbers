...
const config = {
  ...
  content: {
    ...
    formulaExplanation: "CPC = Total Cost ÷ Total Clicks. Example: $1,000 spent generating 500 clicks = $2.00 CPC. If those clicks convert at 3% (15 conversions) with a $40 AOV, your cost per acquisition = $66.67 and ROAS = 0.6x; this shows that CPC alone doesn't determine profitability.",
    ...
    benchmarkData: [
      ...
      { metric: "Instagram Ads Avg CPC", value: "$0.50-1.50", source: "General benchmark" },
      { metric: "TikTok Ads Avg CPC", value: "$0.50-1", source: "General benchmark" },
    ],
