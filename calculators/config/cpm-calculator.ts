...
const config = {
  ...
  content: {
    ...
    benchmarkData: [
      { metric: "Standard Display CPM", value: "$2-5", source: "Industry Average" },
      { metric: "Video Ad CPM", value: "$10-25", source: "Industry Average" },
      { metric: "Premium Placement CPM", value: "$15-50", source: "Digiday" },
      { metric: "Niche B2B CPM", value: "$50-200+", source: "Industry Standard" },
      { metric: "YouTube RPM (Creator)", value: "$2-5", source: "YouTube Analytics" },
      { metric: "Programmatic Display CPM", value: "$1-3", source: "Industry Average" },
    ],
