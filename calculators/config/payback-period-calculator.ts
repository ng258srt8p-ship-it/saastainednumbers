...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How does pricing affect payback period?", answer: "Higher pricing directly improves payback by increasing monthly contribution. A 20% price increase can reduce payback by 15-25% assuming same conversion rates. Track payback period per segment with [Baremetrics](https://baremetrics.com?via=saastainednumbers)." },
