...
const config = {
  ...
  content: {
    ...
    benchmarkData: [
      ...
      { metric: "SaaS Target ROAS", value: "3:1 (300%)", source: "Growth Marketing Benchmark" },
      { metric: "Minimum Profitable ROAS", value: "2:1 (200%)", source: "Industry Standard" },
    ...
    faq: [
      { question: "What is the difference between ROAS and ROI?", answer: "ROAS (Return on Ad Spend) measures gross revenue divided by ad spend — it's campaign-specific and doesn't account for COGS or other costs. ROI (Return on Investment) measures profit divided by total investment, including all costs. ROAS of 4.0 might mean 10% net ROI after COGS, fulfillment, and overhead. Use ROAS for campaign optimization and ROI for business decisions." },
