...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How do I calculate MRR growth rate?", answer: "MRR growth rate = (Current Month MRR - Previous Month MRR) / Previous Month MRR × 100. Track this monthly to measure your company's growth trajectory." },
      ...
      { question: "How does churn impact MRR?", answer: "Churn directly reduces MRR. If you acquire $10K in new MRR but lose $8K to churn, your net new MRR is only $2K. Reducing churn by even 1-2% can dramatically improve net MRR growth." },
