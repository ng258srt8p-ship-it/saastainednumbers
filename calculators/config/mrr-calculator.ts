...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How do I calculate MRR growth rate?", answer: "MRR growth rate = (Current Month MRR - Previous Month MRR) / Previous Month MRR × 100. Track this monthly to measure your company's growth trajectory. Tools like [Baremetrics](https://baremetrics.com?via=saastainednumbers) and [ChartMogul](https://chartmogul.com) automate this tracking." },
