...
const config = {
  ...
  content: {
    ...
    faq: [
      ...
      { question: "How can I grow my Twitch revenue beyond the platform?", answer: "Diversify with [Patreon](https://patreon.com) for exclusive content, [Discord](https://discord.com) memberships, merchandise via [Printful](https://www.printful.com), and brand sponsorships via [SponsorSpot](https://sponsorspot.com). Many top streamers earn 50-70% of their income from sources outside Twitch. Build a YouTube channel for discoverability and edit streams into highlight compilations." },
    ],
  },
