...
const config = {
  ...
  content: {
    ...
    howToUse: "Enter your annual gross income, total monthly debt payments (car loans, student loans, credit card minimums, etc.), available down payment, expected interest rate based on current mortgage rates, loan term, property tax rate for your area, and monthly home insurance estimate. The calculator applies the 36% backend DTI limit to determine your maximum home price. Adjust the interest rate to match today's rates  -  check [Bankrate](https://bankrate.com) or [NerdWallet](https://nerdwallet.com) for current averages. A higher down payment reduces your loan amount and may eliminate PMI. Remember that property taxes and insurance vary significantly by location and should be researched for your target area.",
