...
const config = {
  ...
  content: {
    ...
    faq: [
      { question: "What is a good profit margin for Amazon FBA?", answer: "Target 20-40% net profit margin after all costs. If your margin is below 15%, consider raising prices, reducing costs, or finding a different product. Products priced $15-50 typically have the best margins. Premium products ($50+) can have higher margins but lower volume. Build a brand beyond Amazon with [Shopify](https://shopify.pxf.io/2R5Dza) to diversify sales channels." },
