export interface GeminiAPICostParams {
  inputTokens: number;
  outputTokens: number;
  callsPerDay: number;
...
export interface GeminiAPICostResult {
  costPerCall: number;
  costPerDay: number;
  costPerMonth: number;
  costPerYear: number;
...
export function calculateGeminiAPICost(params: GeminiAPICostParams): GeminiAPICostResult {
