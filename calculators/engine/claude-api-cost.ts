export interface ClaudeAPICostParams {
  inputTokens: number;
  outputTokens: number;
  callsPerDay: number;
...
export interface ClaudeAPICostResult {
  costPerCall: number;
  costPerDay: number;
  costPerMonth: number;
  costPerYear: number;
...
export function calculateClaudeAPICost(params: ClaudeAPICostParams): ClaudeAPICostResult {
