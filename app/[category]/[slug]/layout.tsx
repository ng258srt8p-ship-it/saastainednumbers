      ...
      <div className="mx-auto max-w-4xl px-4 pb-8">
        <section className="mt-12">
          ...
          <div className="mt-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            {renderContent(config.content.intro)}
          </div>
        </section>
        ...
        {config.content.formulaExplanation && (
        ...
        {config.content.faq.length > 0 && (
          <section className="mt-12">
            <h2 className="font-heading text-2xl font-bold text-gray-900 dark:text-gray-100">Frequently Asked Questions</h2>
