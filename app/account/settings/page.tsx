  ...
  if (!session?.user?.id) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-12">
        <h1 className="font-heading text-3xl font-bold text-gray-900 dark:text-gray-100">Account Settings</h1>
        <p className="mt-2 text-gray-500 dark:text-gray-400 mb-8">Manage your account preferences.</p>
    ...
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="space-y-6">
        <div className="rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
          <h2 className="font-heading text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Profile</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Signed in as <strong className="text-gray-900 dark:text-gray-100">{session.user.email}</strong>
          </p>
        </div>

        <div className="rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
          <h2 className="font-heading text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Language</h2>
