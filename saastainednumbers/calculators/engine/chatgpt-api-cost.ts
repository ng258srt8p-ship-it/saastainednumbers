export interface ChatGPTAPICostParams {
  inputTokens: number;
  outputTokens: number;
  callsPerDay: number;
...
export interface ChatGPTAPICostResult {
  costPerCall: number;
  costPerDay: number;
  costPerMonth: number;
  costPerYear: number;
...
export function calculateChatGPTAPICost(params: ChatGPTAPICostParams): ChatGPTAPICostResult {
