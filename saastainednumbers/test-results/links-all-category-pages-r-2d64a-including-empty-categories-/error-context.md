...
- Name: links.spec.ts >> all category pages return 200 (including empty categories)
- Location: tests/e2e/links.spec.ts:45:5

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:3000/revenue
Call log:
  - navigating to "http://localhost:3000/revenue", waiting until "networkidle"
